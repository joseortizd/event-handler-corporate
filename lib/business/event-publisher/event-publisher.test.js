...
describe('Event publisher test suite', function () {
    it('Should instanciate a valid publisher', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log = jest.fn();
                    return [4 /*yield*/, event_publisher_1.publish(ExampleEvent)];
                case 1:
                    response = _a.sent();
