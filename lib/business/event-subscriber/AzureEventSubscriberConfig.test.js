...
describe('Azure event subscriber tests', function () {
    it('Should properly get a message', function () { return __awaiter(void 0, void 0, void 0, function () {
        var OLD_ENV, subcribe, Sbclient, subscriber;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    service_bus_1.ServiceBusClient.prototype.createReceiver = jest.fn().mockReturnValue(Sbclient);
                    subscriber = new AzureEventSubscriberConfig_1.AzureEventSubscriberConfig();
                    return [4 /*yield*/, subscriber.getMessages(new log_event_handler_1.logEventHandler())];
                case 1:
                    _a.sent();
