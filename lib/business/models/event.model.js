...
var EventModel = /** @class */ (function () {
    function EventModel(eventType, entityId, datetime, version, country, commerce, channel, domain, capability, mimeType, entityType, metadata, eventId, timestamp) {
        this.eventId = eventId ? eventId : uuid_1.v4();
