...
process.env.EVENT_HANDLER_PUBLISHER_ABS_CONNECTION_STRING =  "Endpoint=sb://testloggerjg2021.servicebus.windows.net/;SharedAccessKeyName=jg;SharedAccessKey=MPKSmfFSu8haWoCS+McBW4uwX2zIR0nvmbQQPwbB6UQ=";
...
const ExampleEvent : EventModel = new EventModel('Event', '1', new Date(), '1', 'CL', 'seguros', 'MIS_SEGUROS', 'venta', 'sells', '??', JSON.stringify(metadata));
